  ...
  return (
    <div className="w-full h-screen relative bg-[#020617] text-white overflow-hidden flex flex-col p-8">
      ...
      <div className="relative z-10 max-w-2xl space-y-8">
        {/* Company Settings */}
        <div className="bg-black/40 backdrop-blur-xl border border-white/10 rounded-xl p-8 shadow-[0_0_30px_rgba(0,0,0,0.5)]">
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full mt-2 bg-white/5 border border-white/10 rounded px-4 py-3 text-white focus:border-[#00f3ff] outline-none transition-colors"
              />
            </div>
            <button className="px-6 py-2 bg-[#00f3ff]/10 border border-[#00f3ff]/30 text-[#00f3ff] rounded font-bold text-xs uppercase hover:bg-[#00f3ff]/20 transition-all flex items-center gap-2">
        ...
        {/* Gas Tank */}
        <div className="bg-black/40 backdrop-blur-xl border border-[#bd00ff]/30 rounded-xl p-8 shadow-[0_0_30px_rgba(189,0,255,0.1)]">
          ...
          <form onSubmit={handleDeposit} className="flex gap-4 items-end">
            <div className="flex-1">
              ...
              <input
                ...
                placeholder="0.00"
                className="w-full mt-2 bg-white/5 border border-white/10 rounded px-4 py-3 text-white focus:border-[#bd00ff] outline-none transition-colors"
              />
            </div>
            <button
              type="submit"
