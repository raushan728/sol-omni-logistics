    ...
    <div className="w-full h-screen relative bg-[#020617] text-white overflow-hidden flex flex-col p-8">
      ...
      <header className="relative z-10 mb-8 flex justify-between items-center">
        ...
        <div className="flex gap-4">
          <div className="flex items-center gap-2 px-4 py-2 rounded-full bg-[#bd00ff]/10 border border-[#bd00ff]/30 text-[#bd00ff] text-xs font-bold uppercase">
          ...
          {drivers.map((driver) => {
            ...
            return (
              <div
                ...
                className="group relative bg-black/40 backdrop-blur-xl border border-white/10 rounded-xl p-6 hover:border-[#bd00ff]/50 transition-all hover:shadow-[0_0_30px_rgba(189,0,255,0.2)]"
              >
                ...
                <div className="flex justify-between items-start mb-4">
                  <div className="w-12 h-12 rounded-full bg-[#bd00ff]/20 flex items-center justify-center border border-[#bd00ff]/30 text-[#bd00ff] font-bold">
                ...
                <div className="space-y-2 text-sm border-t border-white/5 pt-4">
                  ...
                  <button
                    ...
                    className="w-full mt-4 py-2 bg-white/5 hover:bg-[#bd00ff]/20 hover:text-[#bd00ff] border border-white/10 rounded text-xs font-bold uppercase transition-all"
                  >
                    Emergency Swap / Assign
                  </button>
                </div>
              </div>
            );
