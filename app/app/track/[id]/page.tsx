...
export default function TrackingDetailPage() {
  ...
  return (
    <div className="w-full h-screen relative bg-[#020617] text-white overflow-hidden flex flex-col">
      ...
      {/* Header */}
      <header className="relative z-10 p-6 bg-black/40 backdrop-blur-md border-b border-white/10 flex justify-between items-center">
        <div className="flex items-center gap-4">
          <div className="p-3 bg-white/5 rounded-lg border border-white/10">
            <Package className="w-6 h-6 text-[#bd00ff]" />
          </div>
          <div>
            <h1 className="text-xl font-bold tracking-wider">TRACKING: {id}</h1>
        ...
        <div
          className={`px-4 py-2 rounded font-bold uppercase text-xs ${
            isDelivered
      ...
      <main className="flex-1 relative z-0 flex flex-col md:flex-row">
        ...
        {/* Details Panel */}
        <div className="w-full md:w-96 bg-[#020617] border-l border-white/10 p-8 flex flex-col z-20">
